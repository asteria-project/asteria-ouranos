...
/*
 * Provides tasks for building and testing the "asteria-ouranos" project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "asteria-ouranos" project:
  grunt.registerTask('build', ['ts:build', 'copy:main',
                               'copy:initTypes', 'copy:buildTypesFile',
                               'clean:build']);

  //--> Task: builds the "asteria-ouranos" API documentation:
